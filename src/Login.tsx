...
import { Zap, ShieldCheck, Trophy, Target, Mail, Lock, ArrowRight, Loader2, BookOpen, Eye, EyeOff, User as UserIcon } from 'lucide-react';
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input 
                  ...
                  placeholder="••••••••" 
                  className="pl-10 pr-10 h-12 bg-background/50 border-border/50 focus:border-primary transition-all"
                  value={password}
